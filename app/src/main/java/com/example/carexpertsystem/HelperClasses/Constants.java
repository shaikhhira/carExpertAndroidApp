...
public class Constants {
    ...
    private static final String ROOT_URL = "http://192.168.1.102/carExpertAndroidApp/phpFolder/androdConn/";//chnage everytime by check IPconfig on cmd
    ...
    public static final String URL_SOLUTION = ROOT_URL + "fetchSolution.php?MODELNAME=";

    public static final String URL_RATING=ROOT_URL+"ratingStar.php";
